...
drop_cols = ['cc_num','trans_date_trans_time','trans_num','city','lat','long','job','dob','merch_lat','merch_long','trans_date','state']
...
def update_row(active_cell): 
    ...
    if active_cell: 
        ...
        colors = ['#7FDBFF' if i in active_cell else '#0074D9'
              for i in range(len(X_test))]
        return f"The transaction has probability of {prob}% to being a Fraud"
    else:
